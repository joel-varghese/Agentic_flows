...
tools = [search_and_download_doc_tool, send_email_tool, create_calendar_invite_tool]
...
def chatbot(state:State):
    ...
    3. create_calendar_invite_tool → Use when the user wants to schedule a meeting, send a calendar invite, or create a Google Meet.
